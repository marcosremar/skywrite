    ...
    >
      {withHandle && (
        <div className="z-10 flex h-4 w-3 items-center justify-center rounded-sm border border-white/10 bg-white/5">
          <GripVerticalIcon className="h-2.5 w-2.5 text-white/40" />
        </div>
      )}
    </PanelResizeHandle>
  )
